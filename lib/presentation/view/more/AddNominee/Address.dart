// ignore_for_file: non_constant_identifier_names, camel_case_types, unused_field, use_build_context_synchronously, prefer_typing_uninitialized_variables
...
class _Addresspage extends State<Addresspage> {
  ...
  Future<void> dataFound() async {
    ...
    setState(() {
      ...
      NomineeRelationship = prefs.getString("NomineeRelationship") ?? '';
  ...
  @override
  void onToAccount(String value) async {}
  ...
  //  void citycode(city stateObjectList) {
  //   String? selectedCity = stateObjectList.stat_code;
  ...
  Future<bool> _onBackPressed() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const AddNominee()),
    );
  ...
  final List<Statee> statenamenominee = Statename.relationShipp;
                            ...
                            child: DropdownButton<city>(
                              ...
                              onChanged: (newValue) async {
                                ...
                                String mStateCodeGet =
                                    StateName!.stat_kid.toString();
                                await GetStateCode(mStateCodeGet);
                              },
                            ),
                          ),
                        ),
  ...
  Future<void> GetStateCode(String Code) async {
    ...
    try {
      ...
      // String apiUrl = "$protocol$ip$port/rest/AccountService/getdistName";
...
// API Code............................................................
  ...
  Future<void> OnSubmitButton() async {
    ...
    String jsonString = jsonEncode({
      ...
      "grdname": "",
      "grdrela": "",
      "adrno": txtaddress1.text,
      "adreloc": txtaddress2.text,
      "adrcity": CityNamee.toString(),
      "adrpin": txtpincode.text,
      "grdadrno": "",
      "grdadreloc": "",
      "grdadrcity": "",
      "grdadrpin": "",
