// ignore_for_file: library_private_types_in_public_api, non_constant_identifier_names, deprecated_member_use, unused_local_variable, use_build_context_synchronously
...
class ConfirmPayPage extends StatefulWidget {
  ...
  const ConfirmPayPage({super.key, required this.pendingMessages});
...
class _ConfirmPayPageState extends State<ConfirmPayPage> {
            ...
            body: Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final payee = widget.pendingMessages[index];

                  return Card(
                    color: Colors
                        .white, // Set the background color of the Card here
                        ...
                        children: [
                          ...
                          Center(
                            child: TextButton(
                                                ...
                                                TextButton(
                                                    onPressed: () {
                                                      String otp =
                                                          ...
                                                          if(otp.length < 6){
                                                            DialogboxAlert("Please Enter 6 digit OTP", "Alert");
                                                            return;
                              ...
                              child: const Text('Confirm Payee'),
                            ),
                          ),
                        ],
                      ),
  ...
  Future<void> FinalProceed(String MPIn) async {
    ...
    //String apiUrl = "$protocol$ip$port/rest/AccountService/otpVerify";

    String apiUrl = ApiConfig.otpVerify;
      ...
      if (response.statusCode == 200) {
        ...
        if (data["Result"] == "Success") {
          ...
          if (dataaa["result"] == "success") {
            Message = "Payee Confirmed Successfully.";
