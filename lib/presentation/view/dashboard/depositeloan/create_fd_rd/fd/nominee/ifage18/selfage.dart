...
class SelfAgePage extends StatefulWidget {
  const SelfAgePage({super.key});
  @override
  State<StatefulWidget> createState() => _SelfAgePageSate();
}

class _SelfAgePageSate extends State<SelfAgePage> {
...
//------------------------------------------------------------------------------------------------------
  ...
  Future<void> submitData() async {
    ...
    if (pinNumber.text == "" || pinNumber.text == null) {
      await showDialog(
        context: context,
        builder: (BuildContext context) {
...
//------------------------------------------------------------------------------------------------------
      ...
      String encrypted = AESencryption.encryptString(json.toString(), ibUsrKid);
