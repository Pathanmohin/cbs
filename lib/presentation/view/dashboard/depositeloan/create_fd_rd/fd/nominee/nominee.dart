...
class NomineeFD extends StatefulWidget {
  const NomineeFD({super.key});

  @override
  State<NomineeFD> createState() => _NomineeFDState();
}

class _NomineeFDState extends State<NomineeFD> {
  int? _age;
  bool _isAdult = false;
...
//------------------------------------------------------------------------------------------------------
      ...
      //  context.push('/SelfAgePage');
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => const SelfAgePage()));
