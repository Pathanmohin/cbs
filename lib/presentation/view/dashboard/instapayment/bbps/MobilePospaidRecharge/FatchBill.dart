// ignore_for_file: non_constant_identifier_names, unused_element, unused_local_variable, use_build_context_synchronously, deprecated_member_use
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            //context.push("/successfullyPostpaid");
          } else {
            Loader.hide();
