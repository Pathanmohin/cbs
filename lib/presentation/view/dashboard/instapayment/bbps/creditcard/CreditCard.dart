// ignore_for_file: non_constant_identifier_names, prefer_typing_uninitialized_variables, unused_local_variable, prefer_interpolation_to_compose_strings, deprecated_member_use
                          ...
                          InkWell(
                            onTap: () async {
                              if (FromAccountNumber == null ||
                                ...
                                await DialogboxAlert(Message);
                                return;
                              } else if (MobileNumberCreditcard.text == "") {
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            // ignore: use_build_context_synchronously
            //   context.push('/CreditcardFatchBill');
          } else {
            Loader.hide();
