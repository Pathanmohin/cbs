// ignore_for_file: non_constant_identifier_names, unused_element, use_build_context_synchronously, unused_local_variable
...
class BoardbandFatchBill extends StatefulWidget {
  ...
  const BoardbandFatchBill({super.key, required this.fastTagInfoList});
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            // context.push('/Successfullyboardband');
          } else {
            Loader.hide();
