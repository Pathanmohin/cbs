// ignore_for_file: non_constant_identifier_names, unused_local_variable, deprecated_member_use, prefer_typing_uninitialized_variables
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (contex) =>
                        BoardbandFatchBill(fastTagInfoList: fastTagInfoList)));
          } else {
            Loader.hide();
