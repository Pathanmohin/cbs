// ignore_for_file: non_constant_identifier_names, deprecated_member_use, unused_local_variable, use_build_context_synchronously, prefer_typing_uninitialized_variables
        ...
        if (response.statusCode == 200) {
          ...
          if (responseData["Result"] == "Sucess") {
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => FatchBillWater()));

            //  context.push('/FatchBillWater');
          } else {
            Loader.hide();
