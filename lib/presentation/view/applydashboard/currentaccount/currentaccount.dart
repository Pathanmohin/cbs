...
import 'package:hpscb/presentation/view/applydashboard/currentaccount/CAAadhaarotp/CAAadhaarotp.dart';
...
class CAOpenAccount extends StatefulWidget {
  const CAOpenAccount({super.key});

  @override
  State<CAOpenAccount> createState() => _CAOpenAccountState();
}

class _CAOpenAccountState extends State<CAOpenAccount> {
                      ...
                      children: [
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (value) async {
                              if (value == null || value.isEmpty) {
                                ...
                                await showCustomizeFlushbar(
                                    context, 'Phone number must be 10 digits');
                                return;
                              }
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (value) async {
                              final RegExp panRegExp =
                                  RegExp(r'^[A-Z]{5}[0-9]{4}[A-Z]{1}$');
                              if (value == null || value.isEmpty) {
                                await showCustomizeFlushbar(
                                    context, 'Please enter your PAN number');
                                return;
                              } else if (!panRegExp.hasMatch(value)) {
                                await showCustomizeFlushbar(context,
                                    'Please enter a valid PAN number (e.g., AAAAA0000A)');
                                return;
                              }
                              FocusScope.of(context)
                                  .requestFocus(aadhaarFocusNode);
                            },
                          ),
                        ),
                        const Padding(
            ...
            if (getDataList["aadhaar_validation"] != "") {
              ...
              if (getData["statusCode"] == 200) {
                ...
                if (getRes != null || getRes != "") {
                  ...
                  // await showCustomizeFlushbarComp(
                  //     context, getData["message"].toString());
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const CAAadhaarOTP()));
                } else {
                  Loader.hide();
                  await showDialog(
                    context: context,
