...
class RDCreation extends StatefulWidget {
  const RDCreation({super.key});

  @override
  State<RDCreation> createState() => _RDCreateState();
}

class _RDCreateState extends State<RDCreation> {
  ...
  void _onProceedPressed() async {
    if (_selectedAccountStatus == "Yes") {
      ...
      await QuickAlert.show(
        ...
        type: QuickAlertType.info,
        text:
            'First, open a Savings Account. After that, you can apply for an RD account.',
      );
