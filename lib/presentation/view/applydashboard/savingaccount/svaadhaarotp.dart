...
import 'package:hpscb/presentation/view/applydashboard/savingaccount/svaadhaardetails.dart';
import 'package:hpscb/utility/alertbox.dart';
import 'package:http/http.dart' as http;

class SVAadhaarOTP extends StatefulWidget {
  const SVAadhaarOTP({super.key});
  @override
  State<StatefulWidget> createState() => _SVAadhaarOTPState();
}

class _SVAadhaarOTPState extends State<SVAadhaarOTP> {
  ...
  Future<void> getAadhaarRes() async {
    ...
    try {
     ...
     String apiUrl = ApiConfig.aadharotpverify;
            ...
            if (getDataList["statusCode"].toString() == "200") {
              ...
              if (dataGet["statusCode"] == "200" ||
                ...
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const SVAadhaarCard()));
              } else {
                await showDialog(
                  context: context,
                  builder: (BuildContext context) {
