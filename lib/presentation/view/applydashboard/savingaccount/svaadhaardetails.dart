...
import 'package:hpscb/presentation/view/applydashboard/savingaccount/occupation.dart';
...
class SVAadhaarCard extends StatefulWidget {
  const SVAadhaarCard({super.key});

  @override
  State<StatefulWidget> createState() => _SVAadhaarCardState();
}

class _SVAadhaarCardState extends State<SVAadhaarCard> {
  String base64Image = "";
  String name = "";
      ...
      child: InkWell(
        onTap: () async {
          ...
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => const Occupations()));
        },
        child: Container(
          height: 55,
          decoration: BoxDecoration(
