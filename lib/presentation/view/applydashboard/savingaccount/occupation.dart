// ignore_for_file: non_constant_identifier_names, prefer_final_fields, unnecessary_null_comparison, use_build_context_synchronously, unused_local_variable, prefer_const_literals_to_create_immutables
...
import 'package:hpscb/presentation/view/applydashboard/savingaccount/svpreview.dart';
            ...
            ? () async {
                if (currentStep == 0) {
                  ...
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SVPreView()));
                }
              }
            : null,
        onStepCancel:
...
// ---------------------------------------- Occupation api --------------------------
  ...
  Future<void> OccupationList() async {
    try {
      ...
      String apiUrl = ApiConfig.getocupationMaster;
  ...
  Future<void> BranchGet(String cityID, String cityPINCode) async {
    ...
    try {
      ...
      String apiUrl = ApiConfig.getBrnName;
