...
import 'package:hpscb/presentation/view/applydashboard/savingaccount/finalpage.dart';
...
class SVPreView extends StatefulWidget {
  const SVPreView({super.key});

  @override
  State<StatefulWidget> createState() => _SVPreViewState();
}

class _SVPreViewState extends State<SVPreView> {
  String base64Image = "";
  String name = "";
...
// Nominee Details
          ...
          if (connectivityResult.contains(ConnectivityResult.none)) {
            showDialog(
              ...
              builder: (BuildContext context) {
                return AlertDialog(
                  title: const Text('Alert', style: TextStyle(fontSize: 16)),
  ...
  Future<void> getApiAadhaar() async {
    ...
    try {
      ...
      String apiUrl = ApiConfig.unauthAccountgenebyMobile;
        ...
        if (response.statusCode == 200) {
          ...
          if (res["Result"].toString().toLowerCase() == "success") {
            ...
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => const SVFinalRes()));
