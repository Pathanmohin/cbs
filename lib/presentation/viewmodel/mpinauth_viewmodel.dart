...
import 'package:hpscb/data/repositories/mpinauth_repository.dart';
...
class MpinauthViewmodel with ChangeNotifier{

  final _myRepo = MpinauthRepository();
  ...
  Future<void> mpinLogin(
    ...
    _myRepo.mpinAPI(data, header, context).then((value) async {
